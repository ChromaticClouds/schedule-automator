export const planningSectionEmptyMessages = {
  ...
  '보호 시간': '수면, 식사, 운동처럼 침범하면 안 되는 시간을 추가해 주세요.',
  작업: '아직 작업이 없습니다. 직접 추가하거나 목표를 AI로 분해해 보세요.',
} as const;

export const planningSectionErrorMessages = {
  목표: '목표를 불러오지 못했습니다. 연결 상태를 확인하고 다시 시도해 주세요.',
  '보호 시간': '보호 시간을 불러오지 못했습니다. 잠시 후 다시 시도해 주세요.',
  작업: '작업을 불러오지 못했습니다. 일정을 만들기 전에 다시 시도해 주세요.',
} as const;
